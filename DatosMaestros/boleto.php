<?php
    ...
    $query4=mysqli_query($conn, "SELECT Id_Equipaje, Cantidad FROM equipaje");
    $query5=mysqli_query($conn, "SELECT Id_Clase, Tipo_Clase FROM clase");
    $queryasientos=mysqli_query($conn, "SELECT Id_Lista, Numero_Asiento FROM listaasientos WHERE Estado='1'");
        ...
        <div id="content" style="width:150%;">
                ...
                <div class="col-auto">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form class="row g-3 needs-validation" action="../Procesos/Guardar/boletoAdd.php" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                    ...
                                    <?php 
                                        ...
                                        {
                                    ?>
                                            <option value="<?php echo $datos['Id_Vuelo']?>" data-voo="<?php echo $datos['Id_Vuelo']?>"><?php echo $datos['Codigo']?> </option>
                                    <?php
                                        }
                                    ?> 
                                    </select>
                            ...
                            <label for="rol">Asiento</label>
                                    ...
                                    <?php 
                                        ...
                                        while($datos = mysqli_fetch_array($queryasientos))
                                        {
                                    ?>
                                            <option value="<?php echo $datos['Id_Lista']?>"><?php echo $datos['Numero_Asiento']?> </option>
                                    <?php
                                        }
                                    ?> 
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <?php 
                                        ...
                                        {
                                    ?>
                                            <option value="<?php echo $datos['Id_Equipaje']?>">Cantidad: <?php echo $datos['Cantidad']?> </option>
                                    <?php
                                        }
                                    ?> 
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <?php 
                                        ...
                                        {
                                    ?>
                                            <option value="<?php echo $datos['Id_Clase']?>"><?php echo $datos['Tipo_Clase']?> </option>
                                    <?php
                                        }
                                    ?> 
                                    </select>
