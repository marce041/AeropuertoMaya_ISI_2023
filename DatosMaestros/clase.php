        ...
        <div id="content" style="width:150%;">
                ...
                <div class="col-auto">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form class="row g-3 needs-validation" action="../Procesos/Guardar/claseAdd.php" method="POST" enctype="multipart/form-data">
                                <div class="mb-3">
                                    <label for="rol">Tipo de Clase</label>
