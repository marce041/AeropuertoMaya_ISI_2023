<?php
    ...
    $query=mysqli_query($conn, "SELECT Id_Boleto, Codigo, Id_Vuelo, Id_Equipaje, Id_Clase, Precio FROM boleto WHERE Estado=1");
...
while($i<$rows2){
    if($nombre_tabla[$i]=='DetalleFactura'){
        $j=1;
    }
    $i+=1;
}
        ...
        <div id="content" style="width:150%;">
                ...
                <div class="col-auto">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form class="row g-3 needs-validation" action="../Procesos/Guardar/detallefacturaAdd.php" method="POST" enctype="multipart/form-data">
                                <div class="mb-3">
                                    <label for="rol">Boleto</label>
                                    <select class="form-select" name="estado" id="pais" required>
                                    <option option value="">--- Escoja una opcion ---</option>
                                    <?php 
