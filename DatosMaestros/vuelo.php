<?php
    ...
    $query=mysqli_query($conn, "SELECT Id_Aeropuerto, Nombre FROM aeropuerto");
        ...
        <div id="content" style="width:150%;">
                ...
                <div class="col-auto">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form class="row g-3 needs-validation" action="../Procesos/Guardar/vueloAdd.php" method="POST" enctype="multipart/form-data">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                <label for="rol">Hora llegada</label>
                                  <input class="form-control" name="horall"  type="time" placeholder="Hora llegada" required>
                                </div>
                                <div class="mb-3">
                                <label for="rol">Fecha de vuelo</label>
                                  <input class="form-control" name="fecha" type="date" placeholder="Fecha de vuelo" required>
                                </div>
                                <div class="mb-3">
