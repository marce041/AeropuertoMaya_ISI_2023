<?php
    ...
    $query=mysqli_query($conn, "SELECT Id_Aeronave, Matricula FROM aeronave");
        ...
        <div id="content">
                ...
                <div class="col-auto text-center">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form class="row g-3 needs-validation" action="../Procesos/Guardar/hangaresAdd.php" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                                  <input class="form-control" name="codigo" type="text" placeholder="Código de Hangar" onkeypress="return event.charCode>=48 && event.charCode<=57 || event.charCode>=65 && event.charCode<=90"  minlength="6" maxlength="6" required>
                            </div>
                            <div class="mb-3">
                                  <input class="form-control" name="capacidad" type="text" placeholder="Capacidad" onkeypress="return event.charCode>=48 && event.charCode<=57"  minlength="1" maxlength="2" required>
                            </div>
                            <div class="mb-3">
                                    ...
                                    <?php 
                                        ...
                                        {
                                    ?>
                                            <option value="<?php echo $datos['Id_Aeronave']?>"><?php echo $datos['Matricula']?> </option>
                                    <?php
                                        }
                                    ?> 
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <?php 
                                        ...
                                        {
                                    ?>
                                            <option value="<?php echo $datos['Id_Aeropuerto']?>"><?php echo $datos['Nombre']?> </option>
                                    <?php
                                        }
                                    ?> 
                                    </select>
