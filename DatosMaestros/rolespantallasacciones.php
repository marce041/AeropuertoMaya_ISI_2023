...
while($i<$rows2){
    if($nombre_tabla[$i]=='RolesPantallasAccion'){
        $j=1;
    }
    $i+=1;
}
...
<head>
    ...
    <title>Acciones de pantalla por rol</title>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form class="row g-3 needs-validation" action="../Procesos/Guardar/rolespantallasaccionesAdd.php"  method="POST" enctype="multipart/form-data">
                                <div class="mb-3">
                                    <label for="rolespantallasacciones">Id del rol</label>
                                ...
                                <div class="mb-3">
                                    <label for="rolespantallasacciones">Id de la pantalla</label>
