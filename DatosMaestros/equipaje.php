    ...
    <div id="wrapper">
        ...
        <div id="content" style="width:150%;">
                <nav class="navbar navbar-expand topbar mb-4 text-light shadow" style="background-color:#060724;text-color:white;">
                    ...
                    <h2 style="font-family:Luminari;text-color:white;"><i class="fa-solid fa-cart-flatbed-suitcase"></i> Equipaje</h2>
                ...
                <div class="col-auto">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form class="row g-3 needs-validation" action="../Procesos/Guardar/equipajeAdd.php" method="POST" enctype="multipart/form-data">
                                <div class="mb-3">
                                  <label for="peso">Peso</label>
                                  <input class= "form-control" name="peso" type="text" id="peso" value="40" placeholder="Peso" required pattern="40" title="es obligatorio que sea 40">

                                </div>
                                <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
                                <div class="mb-3">
                                  <input class="form-control" name="cantidad" id="cantidad" type="text"  Onchange = "mostrar('num')"  placeholder="Cantidad" onkeypress="return event.charCode>=48 && event.charCode<=57"  minlength="1" maxlength="6" required pattern="[^0]+|[1-9][0-9]+" title="Su cantidad no debe ser 0">
                                </div>
                            ...
                            document.getElementById("multiplicadorprecio").value = cos;
                            document.getElementById("multiplicadorpre").value = cos;
                            }
                                </script>
                                <div class="mb-3">
                                  <input class="form-control" name="multiplicadorprecio" id="multiplicadorprecio" type="text" placeholder="Multiplicador de Precio" onkeypress="return event.charCode>=48 && event.charCode<=57"  minlength="1" maxlength="6" required disabled>
                                </div>
                              ...
                              <div class="mb-3">
                                  <input class="form-control" name="multiplicadorpre" id="multiplicadorpre" type="hidden" placeholder="Multiplicador de Precio" onkeypress="return event.charCode>=48 && event.charCode<=57"  minlength="1" maxlength="6" required>
                                </div>
                      </form>
                        </div>
                    </div>
