...
try {
    require("../Procesos/ProcesoPasajero/TablaPasajero.php");
  }catch(Exception $e) {
    $datos = date('H:i:s');
    $hora=explode(":", $datos);
    $datos2 = date('d/m/Y');
    ...
    $fecha=explode("/", $datos2);
     ...
     $path = "temp/ConsultaPasajeros-".$fecha[2]."-".$fecha[1]."-".$fecha[0]."_".$hora[0]."_".$hora[1]."_".$hora[2].".log";
    ...
    <div id="wrapper">
        ...
        <div id="content" style="width:150%;">
                <nav class="navbar navbar-expand topbar mb-4 text-light shadow" style="background-color:#060724;text-color:white;">
                    ...
                    <h2 style="font-family:Luminari;text-color:white;"><i class="fa-solid fa-person-walking-luggage"></i> Pasajeros</h2>
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3" style="background-color:#060724;">
                            <h6 class="m-0 font-weight-bold" style="color:#ffff;"><i class="fa-solid fa-person-walking-luggage"></i> Lista de pasajeros</h6>
                            <div style="margin-left:870px;margin-top:-1.5%;">
                                   <a class="btn btn-success" href="../DatosMaestros/pasajero.php" type="post" style="color:white;"> Agregar registro <i class="fa-solid fa-plus"></i></a>
                              </div>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <?php
                                        ...
                                        echo $objetoTabla->mostarTablaPasajero();
                                    ?>
                                </table>
