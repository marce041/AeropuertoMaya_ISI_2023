...
try {
    require("../Procesos/ProcesoVuelo/TablaVuelo.php");
} catch (Exception $e) {
    $datos = date('H:i:s');
    $hora = explode(":", $datos);
    $datos2 = date('d/m/Y');
    ...
    $path = "temp/ConsultaVuelo-" . $fecha[2] . "-" . $fecha[1] . "-" . $fecha[0] . "_" . $hora[0] . "_" . $hora[1] . "_" . $hora[2] . ".log";
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav color sidebar sidebar-dark accordion" id="accordionSidebar">
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../principaladmin.php">
                <div class="sidebar-brand-text mx-3" style="font-family:Luminari;font-size:20px;"> <i
                        class="fa-solid fa-mosque"></i> Emirates Airlines</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages1" class="collapse" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../DatosMaestros/rolespantallasacciones.php">Roles Pantallas
                            Acciones</a>
                    </div>
                </div>
            </li>
        ...
        <!--Termina Lista -->
        <div id="content">
            <nav class="navbar navbar-expand topbar mb-4 text-light shadow"
                style="background-color:#060724;text-color:white;">
                <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
                    <i class="fa fa-bars"></i>
                </button>
                <h2 style="font-family:Luminari;text-color:white;"><i class="fa-solid fa-plane"></i> Vuelo</h2>
            ...
            <div class="container-fluid">
                <div class="card-header py-3" style="background-color:#060724; margin-left:2px;margin-right:0%;">
                <label for="busqueda" style="color:#ffff; "><i class="fa-solid fa-magnifying-glass"></i> Búsqueda de un vuelo </label>
                    ...
                    <div class="container-fluid">
                        <form class="d-flex">
                            ...
                            <input class="form-control me-2 light-table-filter" data-table="table_id" type="text"
                                placeholder="Ingresa algún dato de tu vuelo">
                            <hr>
            ...
            <div class="container-fluid">
                <div class="card shadow mb-4">
                    <div class="card-header py-3" style="background-color:#060724;">
                        <h6 class="m-0 font-weight-bold" style="color:#ffff;"><i class="fa-solid fa-plane"></i> Lista de
                            vuelos</h6>
                        <div style="margin-left:870px;margin-top:-1.5%;">
                            <a class="btn btn-success" href="../DatosMaestros/vuelo.php" type="post"
                                style="color:white;"> Agregar registro <i class="fa-solid fa-plus"></i></a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                echo $objetoTabla->mostarTablaVuelo();
                                ?>
                            </table>
    ...
    <footer class="sticky-footer bg-white">
        <div class="container my-auto">
            <div class="copyright text-center my-auto">
                <span>Copyright &copy; Aerolinea Maya 2023</span>
            </div>
        </div>
    </footer>
    </div>
