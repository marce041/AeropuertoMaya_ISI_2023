...
try {
    require("../Procesos/ProcesoPantallaAcciones/TablaPantallaAcciones.php");
  }catch(Exception $e) {
    $datos = date('H:i:s');
    $hora=explode(":", $datos);
    $datos2 = date('d/m/Y');
    ...
    $fecha=explode("/", $datos2);
     ...
     $path = "temp/ConsultaPantallaAcciones-".$fecha[2]."-".$fecha[1]."-".$fecha[0]."_".$hora[0]."_".$hora[1]."_".$hora[2].".log";
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3" style="background-color:#060724;">
                            <h6 class="m-0 font-weight-bold" style="color:#ffff;"><i class="fa-solid fa-sliders"></i> Lista de acciones de pantalla</h6>
                            <div style="margin-left:870px;margin-top:-1.5%;">
                                   <a class="btn btn-success" href="../DatosMaestros/pantallaacciones.php" type="post" style="color:white;"> Agregar registro <i class="fa-solid fa-plus"></i></a>
                              </div>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <?php
                                        ...
                                        echo $objetoTabla->mostarTablaPantallaAcciones();
                                    ?>
                                </table>
