    ...
    <div id="wrapper">
        ...
        <div id="content" style="width:150%;">
                <nav class="navbar navbar-expand topbar mb-4 text-light shadow" style="background-color:#060724;text-color:white;">
                    ...
                    <h2 style="font-family:Luminari;text-color:white;"><i class="fa-solid fa-ranking-star"></i>  Clases</h2>
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        ...
                        <h6 class="m-0 font-weight-bold" style="color:#ffff;"><i class="fa-solid fa-ranking-star"></i> Lista de clases</h6>
                        <div style="margin-left:870px;margin-top:-1.5%;">
                                   <a class="btn btn-success" href="../DatosMaestros/clase.php" type="post" style="color:white;"> Agregar registro <i class="fa-solid fa-plus"></i></a>
                              </div>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <?php
                                        ...
                                        echo $objetoTabla->mostarTablaClase();
                                    ?>
                                </table>
