    ...
    <div id="wrapper">
        ...
        <div id="content" style="width:150%;">
                <nav class="navbar navbar-expand topbar mb-4 text-light shadow" style="background-color:#060724;text-color:white;">
                    ...
                    <h2 style="font-family:Luminari;text-color:white;"><i class="fa-regular fa-rectangle-list"></i> Detalle de factura</h2>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card-header py-3"style="background-color:#060724;">
                            <h6 class="m-0 font-weight-bold" style="color:#ffff;"><i class="fa-regular fa-pen-to-square"></i> Editar detalle de factura</h6>
                        </div>
                        <div class="card-body">
                                                ...
                                                "
                                                    <tr>
                                                        ...
                                                        <form action='procesarActualizar.php' method='POST'>
                                                            ...
                                                            <td><input type='hidden' value='$data[Id_Detalle]'name='id' ></td>
                                                            <td><select class='form-select' name='estado' id='estado'>
                                                            <option option value='$data[Id_Boleto]'>$data[Id_Boleto]</option>
                                                            "; while($datos = mysqli_fetch_array($query3))
                                                                {
                                                            
                                                                    echo "<option value='$datos[Id_Boleto]'>$datos[Id_Boleto] $datos[Codigo] </option>
                                                            ";
                                                                }
                                                                
                                                            echo" </td>
                                                            </select></td>
                                                            <td><input type='text'  value='$data[Cantidad]' name='cant' disabled ='true'></td>
                                                            <td><input type='text'  value='$data[Descripcion]' name='descrip' disabled='true'></td>
                                                            <td><input type='text'  value='$data[Subtotal]' name='subtot' disabled='true'></td>
                                                            <td><input type='text'  value='$data[Total_Descuento]' name='descue' disabled='true'></td>
                                                            <td><input type='text'  value='$data[Total_Impuesto]' name='impues' disabled='true'></td>
                                                            <td><input type='text'  value='$data[Total]' name='tot' disabled='true'></td>
                                                            <td> <button class='btn btn-success' type='submit' ><i class='fas fa-save'></i></button>
                                                           
                                                            </td>
                                                            <td><input type='hidden'  value='$data[Id_Boleto]' name='boletoanterior' ></td>  
