...
<head>
    ...
    <title>Actualizar Acciones</title>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <?php
                                         include "../../conexion.php";
                                            ...
                                            try {
                                                $query = mysqli_query($conn,"SELECT * FROM acciones WHERE Id_Acciones='$Id'")
                                            ;}catch(Exception $e) {
                                                $datos = date('H:i:s');
                                                $hora=explode(":", $datos);
                                                $datos2 = date('d/m/Y');
                                                ...
                                                $fecha=explode("/", $datos2);
                                                 ...
                                                 $path = "ActualizarAcciones-".$fecha[2]."-".$fecha[1]."-".$fecha[0]."_".$hora[0]."_".$hora[1]."_".$hora[2].".log";
                                                ...
                                                "
                                                    <tr>
                                                        ...
                                                        <form action='procesarActualizar.php' method='POST'>
                                                            ...
                                                            <td><input type='text' value='$data[Id_Acciones]'name='id' readonly></td>
