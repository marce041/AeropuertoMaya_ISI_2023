    ...
    <div id="wrapper">
        ...
        <div id="content" style="width:150%;">
                <nav class="navbar navbar-expand topbar mb-4 text-light shadow" style="background-color:#060724;text-color:white;">
                    ...
                    <h2 style="font-family:Luminari;text-color:white;"><i class="bi bi-airplane-engines-fill"></i> Aeronave</h2>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card-header py-3"style="background-color:#060724;">
                            <h6 class="m-0 font-weight-bold" style="color:#ffff;"><i class="fa-regular fa-pen-to-square"></i> Editar aeronave</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <?php
                                         include "../../conexion.php";
                                            ...
                                            try {
                                                $query = mysqli_query($conn,"SELECT * FROM aeronave WHERE Id_Aeronave='$Id'");
                                              }catch(Exception $e) {
                                                $datos = date('H:i:s');
                                                $hora=explode(":", $datos);
                                                $datos2 = date('d/m/Y');
                                                ...
                                                "
                                                    <tr>
                                                        ...
                                                        <form action='procesarActualizar.php' method='POST'>
                                                            ...
                                                            <td><input type='hidden' value=' $data[Id_Aeronave]'name='id' ></td>
                                                            <td><input type='text'  value=' $data[Matricula]'   name='matricula' ></td>
                                                            <td><input type='text'  value=' $data[Modelo]' name='modelo'></td>
                                                            <td><input type='text'  value=' $data[Capacidad]'   name='capacidad'></td>
                                                            <td><input type='text'  value=' $data[Tamaño]' name='tamanio'></td>
                                                            <td><input type='text'  value=' $data[Tipo]'   name='tipo'></td>
                                                            <td><input type='text'  value=' $data[Area]' name='area'></td>
