...
try {
   ...
   $fecha=explode("/", $datos2);
    ...
    $path = "CiudadPdfSelectUser-".$fecha[2]."-".$fecha[1]."-".$fecha[0]."_".$hora[0]."_".$hora[1]."_".$hora[2].".log";
...
function Header()
{
    ...
    $this->Cell(60);
    // Título
    $this->Cell(70,10,'Reporte de ciudades',0,0,'C');
    ...
    $this->Ln(15);
    $this->Cell(10);
    $this->cell(37,10,'Id de ciudad',1,0,'C',0);
    $this->cell(33,10,'Nombre',1,0,'C',0);
    $this->cell(33,10,'Codigo',1,0,'C',0);
    $this->cell(33,10,'Id de pais',1,0,'C',0);
    $this->cell(33,10,'Terminal',1,1,'C',0);
...
$resultado=$conn->query($consulta);
   ...
   $fecha=explode("/", $datos2);
    ...
    $path = "CiudadPdfSelectCiudad-".$fecha[2]."-".$fecha[1]."-".$fecha[0]."_".$hora[0]."_".$hora[1]."_".$hora[2].".log";
    error_log("\n" .date("d/m/Y H:i:s")." ". $e->getMessage(),3,$path);
    header("Location: ../../Consultas/Consultaciudades.php");
}
...
while($row=$resultado->fetch_assoc()){
    $pdf->Cell(10);
    $pdf->cell(37,10,$row['Id_Ciudad'],1,0,'C',0);
    $pdf->cell(33,10,$row['Nombre'],1,0,'C',0); 
    $pdf->cell(33,10,$row['Codigo'],1,0,'C',0);
    $pdf->cell(33,10,$row['Terminal'],1,0,'C',0);
    $pdf->cell(33,10,$row['Id_Pais'],1,0,'C',0);
    $pdf->Ln(10);
