...
try {
   ...
   $fecha=explode("/", $datos2);
    ...
    $path = "TripulacionPdfSelectUser-".$fecha[2]."-".$fecha[1]."-".$fecha[0]."_".$hora[0]."_".$hora[1]."_".$hora[2].".log";
...
function Header()
{
    ...
    $this->Cell(60);
    // Título
    $this->Cell(70,10,'Reporte de Tripulacion',0,0,'C');
    ...
    $this->cell(50,10,'Horas de Vuelo',1,0,'C',0);
    $this->cell(50,10,'Tipo de Licencia',1,1,'C',0);
...
try {
   ...
   $fecha=explode("/", $datos2);
    ...
    $path = "TripulacionPdfSelectTripulacion-".$fecha[2]."-".$fecha[1]."-".$fecha[0]."_".$hora[0]."_".$hora[1]."_".$hora[2].".log";
    error_log("\n" .date("d/m/Y H:i:s")." ". $e->getMessage(),3,$path);
    header("Location: ../../Consultas/Consultatripulacion.php");
}
...
while($row=$resultado->fetch_assoc()){
    $pdf->Cell(5);
    $pdf->cell(40,10,$row['Id_Tripulacion'],1,0,'C',0);
    $pdf->cell(42,10,$row['Cargo'],1,0,'C',0); 
    $pdf->cell(50,10,$row['Horas_Vuelo'],1,0,'C',0);
    $pdf->cell(50,10,$row['Tipo_Licencia'],1,0,'C',0);
    $pdf->Ln(10);
