...
header('Content-Disposition: attachment;filename="Clase.xlsx"');
...
$spreadsheet ->getProperties()->setTitle("Clase");

$spreadsheet->setActiveSheetIndex(0);
$hojaActiva = $spreadsheet->getActiveSheet();
$hojaActiva->setTitle("Clase");
...
try {
   ...
   $fecha=explode("/", $datos2);
    ...
    $path = "ClaseXLSXSelectUser-".$fecha[2]."-".$fecha[1]."-".$fecha[0]."_".$hora[0]."_".$hora[1]."_".$hora[2].".log";
...
$hojaActiva->setCellValue('A1','Reporte de Clase');
...
$hojaActiva->setCellValue('B2','Tipo Clase');
...
try {
   ...
   $fecha=explode("/", $datos2);
    ...
    $path = "ClaseXLSXSelectClase-".$fecha[2]."-".$fecha[1]."-".$fecha[0]."_".$hora[0]."_".$hora[1]."_".$hora[2].".log";
    error_log("\n" .date("d/m/Y H:i:s")." ". $e->getMessage(),3,$path);
    header("Location: ../../Consultas/Consultaclase.php");
}
...
$hojaActiva->setCellValue('A'. $fila, $row['Id_Clase']);
$hojaActiva->setCellValue('B'. $fila, $row['Tipo_Clase']);
