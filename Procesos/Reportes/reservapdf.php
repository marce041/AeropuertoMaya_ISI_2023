...
function Header()
{
    ...
    $this->Cell(60);
    // Título
    $this->Cell(70,10,'Reporte de Reserva',0,0,'C');
    ...
    $this->cell(42,10,'Codigo',1,0,'C',0);
    $this->cell(70,10,'Pasajero',1,0,'C',0);
...
while($row=$resultado->fetch_assoc()){
    $pdf->Cell(15);
    $pdf->cell(50,10,$row['Id_Reserva'],1,0,'C',0);
    $pdf->cell(42,10,$row['Codigo'],1,0,'C',0);
    $pdf->cell(70,10,$row['Pasajero'],1,0,'C',0);
    $pdf->Ln(10);
