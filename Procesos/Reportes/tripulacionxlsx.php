...
header('Content-Disposition: attachment;filename="Tripulacion.xlsx"');
...
$spreadsheet ->getProperties()->setTitle("Tripulacion");

$spreadsheet->setActiveSheetIndex(0);
$hojaActiva = $spreadsheet->getActiveSheet();
$hojaActiva->setTitle("Tripulacion");
...
try {
   ...
   $fecha=explode("/", $datos2);
    ...
    $path = "TripulacionXLSXSelectUser-".$fecha[2]."-".$fecha[1]."-".$fecha[0]."_".$hora[0]."_".$hora[1]."_".$hora[2].".log";
    error_log("\n" .date("d/m/Y H:i:s")." ". $e->getMessage(),3,$path);
    header("Location: ../../Consultas/Consultatripulacion.php");
}
...
$hojaActiva->setCellValue('A1','Reporte de Tripulacion');
...
$hojaActiva->setCellValue('A2','Cargo');
$hojaActiva->setCellValue('B2','Horas de Vuelo');
$hojaActiva->setCellValue('C2','Licencia');
$hojaActiva->setCellValue('D2','Academia');
...
try {
   ...
   $fecha=explode("/", $datos2);
    ...
    $path = "TripulacionXLSXSelectTripulacion-".$fecha[2]."-".$fecha[1]."-".$fecha[0]."_".$hora[0]."_".$hora[1]."_".$hora[2].".log";
    error_log("\n" .date("d/m/Y H:i:s")." ". $e->getMessage(),3,$path);
    header("Location: ../../Consultas/Consultatripulacion.php");
}
