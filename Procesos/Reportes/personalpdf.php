...
try {
   ...
   $fecha=explode("/", $datos2);
    ...
    $path = "PersonalPdfSelectUser-".$fecha[2]."-".$fecha[1]."-".$fecha[0]."_".$hora[0]."_".$hora[1]."_".$hora[2].".log";
...
try {
   ...
   $fecha=explode("/", $datos2);
    ...
    $path = "PersonalPdfSelectPersonal-".$fecha[2]."-".$fecha[1]."-".$fecha[0]."_".$hora[0]."_".$hora[1]."_".$hora[2].".log";
    error_log("\n" .date("d/m/Y H:i:s")." ". $e->getMessage(),3,$path);
    header("Location: ../../Consultas/Consultapersonaltierra.php");
}
