...
function Header()
{
    ...
    $this->Cell(60);
    // Título
    $this->Cell(70,10,'Reporte de Pase',0,0,'C');
    ...
    $this->Ln(15);
    $this->Cell(5);
    $this->cell(45,10,'Codigo',1,0,'C',0);
    $this->cell(35,10,'Boleto',1,0,'C',0);
    $this->cell(62,10,'Puerta de Embarque',1,0,'C',0);
...
while($row=$resultado->fetch_assoc()){
    $pdf->Cell(5);
    $pdf->cell(45,10,$row['Codigo'],1,0,'C',0);
    $pdf->cell(35,10,$row['Id_Boleto'],1,0,'C',0); 
    $pdf->cell(62,10,$row['Puerta_Embarque'],1,0,'C',0);
