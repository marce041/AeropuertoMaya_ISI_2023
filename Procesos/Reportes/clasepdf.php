...
try {
   ...
   $fecha=explode("/", $datos2);
    ...
    $path = "ClasePdfSelectUser-".$fecha[2]."-".$fecha[1]."-".$fecha[0]."_".$hora[0]."_".$hora[1]."_".$hora[2].".log";
...
function Header()
{
    ...
    $this->Cell(60);
    // Título
    $this->Cell(70,10,'Reporte de Clase',0,0,'C');
...
try {
   ...
   $fecha=explode("/", $datos2);
    ...
    $path = "ClasePdfSelectClase-".$fecha[2]."-".$fecha[1]."-".$fecha[0]."_".$hora[0]."_".$hora[1]."_".$hora[2].".log";
    error_log("\n" .date("d/m/Y H:i:s")." ". $e->getMessage(),3,$path);
    header("Location: ../../Consultas/Consultaclase.php");
}
