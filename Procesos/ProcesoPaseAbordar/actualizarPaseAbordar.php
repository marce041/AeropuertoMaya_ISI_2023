...
<head>
    ...
    <title>Actualizar Pase de Abordar</title>
    ...
    <div id="wrapper">
        ...
        <div id="content" style="width:150%;">
                <nav class="navbar navbar-expand topbar mb-4 text-light shadow" style="background-color:#060724;text-color:white;">
                    ...
                    <h2 style="font-family:Luminari;text-color:white;"><i class="bi bi-ticket-perforated"></i> Pase de abordar</h2>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card-header py-3"style="background-color:#060724;">
                            <h6 class="m-0 font-weight-bold" style="color:#ffff;"><i class="fa-regular fa-pen-to-square"></i> Editar pase de abordar</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <?php
                                         include "../../conexion.php";
                                            ...
                                            try {
                                                $query = mysqli_query($conn,"SELECT * FROM paseabordar WHERE Id_Pase='$Id'")
                                            ;}catch(Exception $e) {
                                                $datos = date('H:i:s');
                                                $hora=explode(":", $datos);
                                                $datos2 = date('d/m/Y');
                                                ...
                                                "
                                                    <tr>
                                                        ...
                                                        <form action='procesarActualizar.php' method='POST'>
                                                            ...
                                                            <td><input type='hidden' value=' $data[Id_Pase]'name='id' ></td>
                                                            <td><input type='text'  value=' $data[Codigo]'   name='codigo' ></td>
                                                            <td><input type='text'  value=' $data[Fecha]' name='fecha'></td>
                                                            <td><input type='text'  value=' $data[Puerta_Embarque]'   name='puertaembarque'></td>
                                                            <td><input type='text'  value=' $data[Id_Boleto]' name='estado'></td>
                                                            <td><input type='text'  value=' $data[Id_Pasajero]' name='estado2'></td>
