                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary text-center">TABLA EDICION DE FACTURA</h6>
                        </div>
                        <div class="card-body">
                                                ...
                                                "
                                                    <tr>
                                                        ...
                                                        <form action='procesarActualizar.php' method='POST'>
                                                            ...
                                                            <td><input type='text'  value='$data[RTN]'   name='rtn' ></td>
                                                            <td><input type='text'  value='$data[CAI]'   name='cai' ></td>
