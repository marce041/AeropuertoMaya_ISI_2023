        ...
        <div id="content" style="width:150%;">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card-header py-3"style="background-color:#060724;">
                            <h6 class="m-0 font-weight-bold" style="color:#ffff;"><i class="fa-regular fa-pen-to-square"></i> Editar factura</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <?php
                                         include "../../conexion.php";   
                                            $query3=mysqli_query($conn, "SELECT Id_Detalle, Descripcion FROM detallefactura");
                                            $query4=mysqli_query($conn, "SELECT Id_Moneda, Nombre FROM moneda");
                                            $Id=$_GET['id'];
                                            
                                            date_default_timezone_set('America/Mexico_City');
                                            try {
                                                $query = mysqli_query($conn,"SELECT * FROM factura WHERE Id_Factura='$Id'")
                                            ;}catch(Exception $e) {
                                                $datos = date('H:i:s');
                                                $hora=explode(":", $datos);
                                                $datos2 = date('d/m/Y');
                                                ...
                                                $fecha=explode("/", $datos2);
                                                 ...
                                                 $path = "ActualizarFactura-".$fecha[2]."-".$fecha[1]."-".$fecha[0]."_".$hora[0]."_".$hora[1]."_".$hora[2].".log";
                                                        ...
                                                        <form action='procesarActualizar.php' method='POST'>
                                                            ...
                                                            <option option value='$data[Id_Detalle]'>$data[Id_Detalle]</option>
                                                                ...
                                                                "; while($datos = mysqli_fetch_array($query3))
                                                                {
                                                                    ...
                                                                    echo "<option value='$datos[Id_Detalle]'>$datos[Id_Detalle] $datos[Descripcion] </option>
                                                            ";
                                                                }
                                                            echo" </td>
                                                            <td><input type='text'  value=' $data[Fecha]'   name='fecha' ></td>
                                                            <td><select name='estado3' id='equipaje'>
                                                            <option option value='$data[Id_Moneda]'>$data[Id_Moneda]</option>
                                                    
                                                                "; while($datos = mysqli_fetch_array($query4))
                                                                {
                                                            
                                                                    echo "<option value='$datos[Id_Moneda]'>$datos[Id_Moneda] $datos[Nombre] </option>
                                                            ";
                                                                }
                                                            ...
                                                            <td><input type='text' disabled='true' value='$data[Monto]' name='monto' ></td>

                                                            <td><select name='metodo' id='metodo' onchange='carg(this);'>
                                                            <option option value='$data[Metodo_Pago]'>$data[Metodo_Pago]</option>
                                                            <option value='Efectivo'>Efectivo</option>
                                                            <option value='Tarjeta'>Tarjeta</option>
                                                            <option value='Mixto'>Mixto</option>
                                                            </select></td>
                                                            <td><input type='text'  value='$data[Cantidad_Efectivo]'   name='efectivo' id='efectivo' disabled='true'></td>
                                                            <td><input type='text'  value='$data[Numero_Tarjeta]'   name='tarjeta' id='tarjeta' disabled='true'></td>
