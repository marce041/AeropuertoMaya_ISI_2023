...
<head>
    ...
    <title>Actualizar Boletos</title>
    ...
    <div id="wrapper">
        ...
        <div id="content" style="width:150%;">
                <nav class="navbar navbar-expand topbar mb-4 text-light shadow" style="background-color:#060724;text-color:white;">
                    ...
                    <h2 style="font-family:Luminari;text-color:white;"><i class="bi bi-ticket-perforated"></i> Boleto</h2> 
                ...
                <div class="container-fluid">
                    ...
                    <div class="card-header py-3"style="background-color:#060724;">
                            <h6 class="m-0 font-weight-bold" style="color:#ffff;"><i class="fa-regular fa-pen-to-square"></i> Editar boleto</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <?php
                                         ...
                                         $query4=mysqli_query($conn, "SELECT Id_Lista, Numero_Asiento FROM listaasientos WHERE Estado='1'");
                                         $query2=mysqli_query($conn, "SELECT Id_Pasajero, Nombre FROM pasajero");
                                         $query3=mysqli_query($conn, "SELECT Id_Vuelo, Codigo FROM vuelo");
                                         $query5=mysqli_query($conn, "SELECT Id_Equipaje, Cantidad FROM equipaje");
                                         $query6=mysqli_query($conn, "SELECT Id_Clase, Tipo_Clase FROM clase");
                                            $Id=$_GET['id'];
                                                ...
                                                "
                                                    <tr>
                                                        ...
                                                        <form action='procesarActualizar.php' method='POST'>
                                                            ...
                                                            <td><input type='hidden' value=' $data[Id_Boleto]'name='id' ></td>
                                                            <td><input type='text'  value=' $data[Codigo]'   name='codigo' ></td>
                                                            <td><select name='estado' id='aeronave'>
                                                            <option option value='$data[Id_Asiento]'>$data[Id_Asiento]</option>
                                                    
                                                                "; while($datos = mysqli_fetch_array($query4))
                                                                {
                                                            
                                                                    echo "<option value=' $datos[Id_Lista]'>$datos[Id_Lista]  $datos[Numero_Asiento] </option>
                                                            ";
                                                                }
                                                            echo" 
                                                            </select></td>
                                                            <td><select name='estado2' id='pasajero'>
                                                            <option option value='$data[Id_Pasajero]'>$data[Id_Pasajero]</option>
                                                    
                                                                "; while($datos = mysqli_fetch_array($query2))
                                                                {
                                                            
                                                                    echo "<option value=' $datos[Id_Pasajero]'>$datos[Id_Pasajero] $datos[Nombre] </option>
                                                            ";
                                                                }
                                                            echo" 
                                                            </select></td>
                                                            <td><select name='estado3' id='vuelo'>
                                                            <option option value='$data[Id_Vuelo]'>$data[Id_Vuelo]</option>
                                                    
                                                                "; while($datos = mysqli_fetch_array($query3))
                                                                {
                                                            
                                                                    echo "<option value=' $datos[Id_Vuelo]'>$datos[Id_Vuelo] $datos[Codigo] </option>
                                                            ";
                                                                }
                                                            echo" 
                                                            </select></td>
                                                            <td><select name='estado5' id='vuelo'>
                                                            <option option value='$data[Id_Equipaje]'>$data[Id_Equipaje]</option>
                                                    
                                                                "; while($datos = mysqli_fetch_array($query5))
                                                                {
                                                            
                                                                    echo "<option value=' $datos[Id_Equipaje]'>$datos[Id_Equipaje] Cantidad $datos[Cantidad] </option>
                                                            ";
                                                                }
                                                            echo" 
                                                            </select></td>
                                                            <td><select name='estado6' id='vuelo'>
                                                            <option option value='$data[Id_Clase]'>$data[Id_Clase]</option>
                                                    
                                                                "; while($datos = mysqli_fetch_array($query6))
                                                                {
                                                            
                                                                    echo "<option value=' $datos[Id_Clase]'>$datos[Tipo_Clase] </option>
                                                            ";
                                                                }
                                                            echo" 
                                                            </select></td>
                                                            <td><input type='text' disabled='true' value=' $data[Precio]'name='precio'></td>
                                                            <td> <button class='btn btn-success' type='submit' ><i class='fas fa-save'></i></button>
                                                           
                                                            </td>
                                                            
                                                            <td><input type='hidden'  value='$data[Id_Asiento]' name='asientoanterior' ></td>
                                                        </form>
                                                    </tr>
