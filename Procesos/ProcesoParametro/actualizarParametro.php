        ...
        <div id="content" style="width:150%;">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card-header py-3"style="background-color:#060724;">
                            <h6 class="m-0 font-weight-bold" style="color:#ffff;"><i class="fa-regular fa-pen-to-square"></i> Editar acciones</h6>
                        </div>
                        <div class="card-body">
                                                ...
                                                "
                                                    <tr>
                                                        ...
                                                        <form action='procesarActualizar.php' method='POST'>
                                                            ...
                                                            <td><input type='hidden' value=' $data[Id_Parametro]'name='id' ></td>
                                                            <td><input type='text'  value=' $data[Cai]'   name='cai' ></td>
                                                            <td><input type='text'  value=' $data[Fecha_Ven]' name='fecha_ven'></td>
                                                            <td><input type='text'  value=' $data[Fecha_Emi]'   name='fecha_emi'></td>
                                                            <td><input type='text'  value=' $data[Rango_Ini]' name='rango_ini'></td>
                                                            <td><input type='text'  value=' $data[Rango_Fin]'   name='rango_fin'></td>
                                                            <td><input type='text'  value=' $data[Consecutivo]'   name='consecutivo'></td>
