...
<head>
    ...
    <title>Actualizar Aeropuerto</title>
        ...
        <div id="content" style="width:150%;">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card-header py-3"style="background-color:#060724;">
                            <h6 class="m-0 font-weight-bold" style="color:#ffff;"><i class="fa-regular fa-pen-to-square"></i> Editar aeropuerto</h6>
                        </div>
                        <div class="card-body">
                                                ...
                                                "
                                                    <tr>
                                                        ...
                                                        <form action='procesarActualizar.php' method='POST'>
                                                            ...
                                                            <td><input type='hidden' value=' $data[Id_Aeropuerto]'name='id' ></td>
                                                            <td><input type='text'  value=' $data[Nombre]'   name='nombre' ></td>
                                                            <td><input type='text'  value=' $data[Hangar]' name='hangar'></td>
                                                            <td><select name='estado' id='equipaje'>
                                                            <option option value='$data[Id_Ciudad]'>$data[Id_Ciudad]</option>
                                                    
                                                                "; while($datos = mysqli_fetch_array($query2))
                                                                {
                                                            
                                                                    echo "<option value=' $datos[Id_Ciudad]'>$datos[Id_Ciudad] $datos[Nombre] </option>
                                                            ";
                                                                }
                                                            echo" 
                                                            </select></td>
