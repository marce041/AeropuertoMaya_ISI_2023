...
<head>
    ...
    <title>Actualizar Personal de Tierra</title>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages3" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../../Consultapersonaltierra.php">PersonalTierra</a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary text-center">TABLA EDICION DE PERSONAL DE TIERRA</h6>
                        </div>
                        <div class="card-body">
                                                ...
                                                "
                                                    <tr>
                                                        ...
                                                        <form action='procesarActualizar.php' method='POST'>
                                                            ...
                                                            <td><input type='hidden' value=' $data[Id_Personal]'name='id' ></td>
                                                            <td><input type='text'  value=' $data[Carga_Academica]'   name='cargaacademica' ></td>
