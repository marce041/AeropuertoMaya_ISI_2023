...
<head>
    ...
    <title>Actualizar Equipaje</title>
        ...
        <div id="content" style="width:150%;">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card-header py-3"style="background-color:#060724;">
                            <h6 class="m-0 font-weight-bold" style="color:#ffff;"><i class="fa-regular fa-pen-to-square"></i> Editar equipaje</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <?php
                                         include "../../conexion.php";
                                            ...
                                            try {
                                                $query = mysqli_query($conn,"SELECT * FROM equipaje WHERE Id_Equipaje='$Id'")
                                            ;}catch(Exception $e) {
                                                $datos = date('H:i:s');
                                                $hora=explode(":", $datos);
                                                $datos2 = date('d/m/Y');
                                                ...
                                                $fecha=explode("/", $datos2);
                                                 ...
                                                 $path = "ActualizarEquipaje-".$fecha[2]."-".$fecha[1]."-".$fecha[0]."_".$hora[0]."_".$hora[1]."_".$hora[2].".log";
                                                ...
                                                "
                                                    <tr>
                                                        ...
                                                        <form action='procesarActualizar.php' method='POST'>
                                                            ...
                                                            <td><input type='hidden' value='$data[Id_Equipaje]'name='id' ></td>
                                                            <td><input type='hidden'  value='$data[Peso]' name='peso' ></td>
                                                            <script src='https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js'></script>
                                                            <td><input type='text'  value='$data[Cantidad]' Onchange = 'mostrar(`num`)' id='cantidad' name='cantidad'></td>
                                                            <script>
                                                            ...
                                                            <td><input type='text'  value='$data[MultiplicadorPrecio]' name='multiplicadorprecio' id='multiplicadorprecio' disabled='true'></td>

                                                            <td> <button class='btn btn-success' type='submit' ><i class='fas fa-save'></i></button>
                                                           
                                                            </td>
                                                            <td><input type='hidden' value='$data[MultiplicadorPrecio]' id='multiplicadorpre' name='multiplicadorpre'></td>
