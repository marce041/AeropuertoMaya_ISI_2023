...
<head>
    ...
    <title>Actualizar Pasajeros</title>
    ...
    <div id="wrapper">
        ...
        <div id="content" style="width:150%;">
                <nav class="navbar navbar-expand topbar mb-4 text-light shadow" style="background-color:#060724;text-color:white;">
                    ...
                    <h2 style="font-family:Luminari;text-color:white;"><i class="fa-solid fa-person-walking-luggage"></i> Pasajero</h2>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card-header py-3"style="background-color:#060724;">
                            <h6 class="m-0 font-weight-bold" style="color:#ffff;"><i class="fa-regular fa-pen-to-square"></i> Editar pasajero</h6>
                        </div>
                        <div class="card-body">
                                                ...
                                                "
                                                    <tr>
                                                        ...
                                                        <form action='procesarActualizar.php' method='POST'>
                                                            ...
                                                            <td><input type='hidden' value=' $data[Id_Pasajero]'name='id' ></td>
                                                            <td><input type='text'  value=' $data[Nombre]'   name='nombre' ></td>
                                                            <td><select name='estado' id='tipdocumento'>
                                                            <option option value='$data[Tipo_Documento]'>$data[Tipo_Documento]</option>
                                                            <option value='DNI'>DNI</option>
                                                            <option value='Pasaporte'>Pasaporte</option>
                                                            </select></td>
                                                            <td><input type='text'  value=' $data[Numero_Documento]'   name='documento' ></td>
                                                            <td><input type='text'  value=' $data[Telefono]'   name='telefono' ></td>
                                                            <td><input type='text'  value=' $data[Correo]'   name='correo' ></td>
                                                            <td><select name='estado2' id='pais'>
                                                            <option option value='$data[Id_Pais]'>$data[Id_Pais]</option>
                                                    
                                                                "; while($datos = mysqli_fetch_array($query2))
                                                                {
                                                            
                                                                    echo "<option value=' $datos[Id_Pais]'>$datos[Id_Pais] $datos[Nombre] </option>
                                                            ";
                                                                }
                                                            echo" 
                                                            </select></td>
                                                            <td><input type='text'  value=' $data[Fecha_Nacimiento]'   name='fechaN' ></td>
