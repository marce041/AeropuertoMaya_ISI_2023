            ...
            <li class="nav-item">
                ...
                <div id="collapsePages4" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="Consultausuarios.php">Consulta de Usuario</a>
                    </div>
                </div>
            </li>
        </ul>
                ...
                <div class="col-auto text-center">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3"style="background-color:#060724;">
                            <h6 class="m-0 font-weight-bold" style="color:#ffff;"><i class="fa-solid fa-users"></i> Insertar Datos
                            </h6>
                        </div>
                        <div class="card-body">
                            <form class="row g-3 needs-validation" action="../AddUsuario.php" novalidate method="POST" enctype="multipart/form-data">
                                <div class="mb-3">
                                  <input class="form-control" name="Usuario" type="text" placeholder="Nombre de usuario" onkeypress="return event.charCode>=48 && event.charCode<=57 || event.charCode>=65 && event.charCode<=90 || event.charCode>=97 && event.charCode<=122 || event.charCode===95"  minlength="4" maxlength="16" required>
                                </div>
                                <div class="mb-3">
